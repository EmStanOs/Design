...
public class RedisUtil {
    ...
    public RedisUtil(RedisTemplate<Object, Object> jsonRedisTemplate) {
    ...
    public long setRemove(String key, Object... values) {
        try {
            return jsonRedisTemplate.opsForSet().remove(key, values);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            return jsonRedisTemplate.opsForList().remove(key, count, value);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
